...
class DailyForecast1 extends StatefulWidget {
  //const DailyForecast({ Key? key }) : super(key: key);

  @override
  _DailyForecast1State createState() => _DailyForecast1State();
}

class _DailyForecast1State extends State<DailyForecast1> {
