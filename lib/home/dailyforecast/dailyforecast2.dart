...
class DailyForecast2 extends StatefulWidget {
  //const DailyForecast({ Key? key }) : super(key: key);

  @override
  _DailyForecast2State createState() => _DailyForecast2State();
}

class _DailyForecast2State extends State<DailyForecast2> {
